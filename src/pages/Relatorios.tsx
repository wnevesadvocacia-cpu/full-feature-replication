  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <KpiCard title="Prazos Pendentes" value={pendingTasks} icon={Clock} color="bg-amber-500" />
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2">
              ...
              Prazos Pendentes por Prioridade
            </CardTitle>
          </CardHeader>
          <CardContent>
                ...
                {overdueTasks > 0 && (
                  <div className="mt-4 p-3 rounded-lg bg-red-50 border border-red-200 dark:bg-red-950 dark:border-red-800">
                    <p className="text-sm text-red-700 dark:text-red-300 flex items-center gap-2">
                      ...
                      {overdueTasks} prazo{overdueTasks !== 1 ? 's' : ''} atrasada{overdueTasks !== 1 ? 's' : ''}
                    </p>
                  </div>
                )}
              </div>
